      ...
      <BottomSheetView style={styles.contentContainer}>
        <View style={{ gap: hp(1.6) }}>
          ...
          <View style={styles.additionalInfo}>
            ...
            >
              Tips for getting audit approved
            </Text>
            <View>
              <Text
                style={{
              ...
              >
                1.Tips for getting audit approved
              </Text>
              <Text
                style={{
                  fontSize: scale(12),
              ...
              >
                2.Keep checking the portal for new opportunities
              </Text>
              <Text
                style={{
                  fontSize: scale(12),
              ...
              >
                3.Apply for the opportunities as soon as they are live on the
                portal
              </Text>
            </View>
          </View>
